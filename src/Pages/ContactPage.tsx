    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50 pt-16">
                {/* Hero Section */}
                <div className="bg-gradient-to-r from-blue-600 to-blue-600 text-white py-16 md:py-20">
                        ...
                        <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-2xl border-2 border-blue-100">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                                ...
                                <button
                                    type="submit"
                                    disabled={formStatus === 'loading'}
                                    className="w-full bg-gradient-to-r from-blue-600 via-blue-600 to-blue-600 hover:from-blue-600 hover:via-blue-700 hover:to-blue-700 text-white font-black py-4 sm:py-5 text-base sm:text-lg rounded-xl transition-all flex items-center justify-center gap-3 shadow-xl transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                                >
                                    {formStatus === 'loading' ? (
                                        <>
                            ...
                            <div className="bg-white rounded-3xl p-8 sm:p-10 shadow-2xl border-2 border-blue-100">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4 p-5 bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl hover:shadow-lg transition-all">
                                        <div className="bg-gradient-to-br from-blue-600 to-blue-600 p-3 rounded-xl flex-shrink-0 shadow-md">
